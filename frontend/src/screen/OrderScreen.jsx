...
const OrderScreen = () => {
  ...
  // اگر orderId موجود نباشد یا کاربر login نکرده باشد query اجرا نشود
  const skipQuery = !orderId;

  // فراخوانی فقط با orderId
  ...
  const deliverOrderHandler = async () => {
    try {
      ...
      toast.error(err?.data?.message || err.error || 'Deliver failed');
    }
  };

  if (skipQuery) {
    return <Message variant="danger">Order ID missing</Message>;
  }
